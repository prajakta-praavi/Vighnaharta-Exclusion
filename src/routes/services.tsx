...
import { company, productLineup2026 } from "@/content/extrusion";
...
export default function ServicesPage() {
  return (
    <SiteLayout>
      <PageHero eyebrow="Services" title="Professional extrusion service is our core competence." subtitle="From machine setup to spares, die heads, calibration and process troubleshooting, Vighnaharta Enterprise supports the full extrusion line." />
      <Breadcrumb items={[{ to: "/", label: "Home" }, { label: "Services" }]} />

...
export default function IndustriesPage() {
  return (
    <SiteLayout>
      <PageHero eyebrow="Applications" title="Built around extrusion and post-extrusion needs." subtitle="The document focuses on CPVC, conduit and PVC pipe applications, machine spares, die heads, calibration and full line support." />
      <Breadcrumb items={[{ to: "/", label: "Home" }, { label: "Applications" }]} />

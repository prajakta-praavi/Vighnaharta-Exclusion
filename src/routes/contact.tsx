...
export default function ContactPage() {
  ...
  return (
    <SiteLayout>
      <PageHero eyebrow="Contact" title="Talk to our extrusion experts." subtitle="Share your machine model, pipe type, output requirement, die-head need or process issue. Our team will respond with practical guidance." />
        ...
        <div className="container-x grid lg:grid-cols-[1.3fr_1fr] gap-10">
          <div className="bg-card border border-border rounded-xl p-7 shadow-sm">
            ...
            {sent ? (
              ...
              <form className="mt-5 grid sm:grid-cols-2 gap-3" onSubmit={(e) => { e.preventDefault(); setSent(true); }}>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-safety/40 bg-safety/10 p-6">
              ...
              <a href={`tel:${company.phone.replace(/\s/g, "")}`} className="mt-3 inline-block font-display text-2xl font-bold text-brand">{company.phone}</a>
            </div>
            <div className="bg-card border border-border rounded-xl p-6">

        ...
        <div className="container-x grid lg:grid-cols-[1.4fr_1fr] gap-10">
          <div>
            ...
            <div className="mt-6 space-y-3">
              {ROLES.map((r) => (
                <div key={r.t} className="bg-card border border-border rounded-xl p-5 flex flex-wrap items-center justify-between gap-3 hover:border-safety hover:shadow-md transition">
                  <div>
                  ...
                  <a href="#apply" className="rounded-md bg-brand px-4 py-2 text-sm font-semibold text-brand-foreground hover:opacity-90">Apply</a>
                </div>
              ))}
            </div>
          </div>
          <div id="apply" className="bg-secondary rounded-xl p-7 self-start">

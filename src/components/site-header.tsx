    ...
    >
      <div className="bg-brand text-brand-foreground text-xs">
        <div className="container-x flex h-9 items-center justify-between">
          <span className="hidden sm:inline opacity-80">Extrusion machine spares, die heads and complete pipe line project support</span>
      ...
      <div className="container-x flex h-16 items-center justify-between gap-4">
        <Link to="/" className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0 leading-tight">
            <div className="font-display font-bold text-brand truncate">{company.shortName}</div>
